...
#### Simple Linear Regression - One input feature only
cor(Boston$lstat ,Boston$medv) ## Strong negative COrrelation
...
## Builing a LR Model on Train Data
model = lm(medv~lstat,data=trainData)
summary(model)
abline(model,col='red')

###Computing RMSE on Test Data
preds = predict(model,testData) ## predict using test data
